...
def extract_and_save_images_from_pdf_with_pymupdf(pdf_path, output_file):
    ...
    for current_page in range(pdf_document.page_count):
        ...
        for image_index, img in enumerate(images):
            # Пропустить первое изображение на каждой странице
            if image_index == 0:
                continue
...
for page_number in range(2, 46):
    extracted_image_path = extract_images_from_combined_file(
        'C:/Users/79819/Documents/GitHub/instruction_bot/admi_images.png', page_number, page_heights, output_folder)
...
for page_number in range(2, 19):
    oper_image_path = extract_images_from_combined_file(
        'C:/Users/79819/Documents/GitHub/instruction_bot/oper_images.png', page_number, page_heights, output_folder)
